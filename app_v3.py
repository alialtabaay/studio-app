...
if not st.session_state["logged_in"]:
    ...
    with tab2:
        ...
        with tab_add_manual:
            ...
            with st.form("add_manual_inventory_form"):
                col1, col2 = st.columns(2)
        ...
        with tab_add_excel:
            ...
            with col1:
                ...
                st.download_button(
                    label="📥 تحميل قالب Excel", key="download_template_1",
                    data=csv_template,
        ...
        with tab_add_excel:
            ...
            with col1:
                ...
                st.download_button(
                    label="📥 تحميل قالب Excel", key="download_template_2",
                    data=csv_template,
                    file_name="قالب_المعدات.csv",
                    mime="text/csv",
                    use_container_width=True
    ...
    with tab5:
        ...
        if report_type == "📊 الإحصائيات":
            ...
            if inventory:
                ...
                st.download_button(
                    label="📥 تحميل التقرير (CSV)", key="download_report_1",
                    data=csv_data,
            ...
            if loans:
                ...
                csv_data = df.to_csv(index=False, encoding='utf-8-sig')
                st.download_button(
                    label="📥 تحميل التقرير (CSV)", key="download_report_2",
                    data=csv_data,
